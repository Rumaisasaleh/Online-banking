...
if (depositeAmount<=0) {
    ...
    depositresult.innerHTML = `<span style="color: white;">Your current balance is ${balanceAmount}</span>`;
...
if (withdrawAccno in localStorage) {
    ...
    if (withdrawAmount <= Account.balance) {
        ...
        Withdrawresult.innerHTML = `<span style="color: white;">Your current balance is ${Account.balance}</span>`;
